...
watch(
  () => props.modelValue,
  (val) => {
    selected.value = new Set(val ? val.split(',').filter(Boolean) : [])
  },
  { immediate: true },
)
...
const PART_LABELS: Record<string, string> = {
  'head': 'Head (back)', 'face': 'Face', 'neck': 'Neck',
  ...
  'leg-left': 'Left leg', 'leg-right': 'Right leg',
}

const currentParts = () => view.value === 'front' ? FRONT_PARTS : BACK_PARTS
...
<template>
  <div class="flex flex-col gap-4">
    ...
    <div class="flex items-center justify-between">
      <div class="flex rounded-md border border-border overflow-hidden">
        <button
          ...
          :class="view === 'front' ? 'bg-primary text-primary-foreground' : 'bg-background text-muted-foreground hover:text-foreground'"
          @click="view = 'front'"
        >
          Front
        </button>
        <button
          class="px-4 py-1.5 text-sm font-medium transition-colors border-l border-border"
          :class="view === 'back' ? 'bg-primary text-primary-foreground' : 'bg-background text-muted-foreground hover:text-foreground'"
          @click="view = 'back'"
        >
          Back
        </button>
      </div>
      <span v-if="selected.size > 0" class="text-sm text-muted-foreground">
    ...
    <div class="flex justify-center">
      ...
      >
        ...
        <template v-if="view === 'front'">
          <path :class="partClass('head')" @click="toggle('head')"
          ...
          <path :class="partClass('face')" @click="toggle('face')"
          ...
          <path :class="partClass('neck')" @click="toggle('neck')"
          ...
          <path :class="partClass('arm-left')" @click="toggle('arm-left')"
          ...
          <path :class="partClass('elbow-left')" @click="toggle('elbow-left')"
            d="m 28.325215,27.370125 -0.005,3.09419 0.57959,1.91184 0.54538,-2.41185 z" />
          <path :class="partClass('hands-left')" @click="toggle('hands-left')"
          ...
          <path :class="partClass('arm-right')" @click="toggle('arm-right')"
          ...
          <path :class="partClass('hand-right')" @click="toggle('hand-right')"
          ...
          <path :class="partClass('chest-left')" @click="toggle('chest-left')"
          ...
          <path :class="partClass('ribs-left')" @click="toggle('ribs-left')"
          ...
          <path :class="partClass('ribs-right')" @click="toggle('ribs-right')"
          ...
          <path :class="partClass('belly-left')" @click="toggle('belly-left')"
          ...
          <path :class="partClass('belly')" @click="toggle('belly')"
          ...
          <path :class="partClass('genitalia')" @click="toggle('genitalia')"
          ...
          <path :class="partClass('thigh-left')" @click="toggle('thigh-left')"
          ...
          <path :class="partClass('knee-left')" @click="toggle('knee-left')"
          ...
          <path :class="partClass('knee-right')" @click="toggle('knee-right')"
          ...
          <path :class="partClass('calf-left')" @click="toggle('calf-left')"
          ...
          <path :class="partClass('calf-right')" @click="toggle('calf-right')"
          ...
          <path :class="partClass('feet-left')" @click="toggle('feet-left')"
          ...
          <path :class="partClass('right-feet')" @click="toggle('right-feet')"
        ...
        <template v-if="view === 'back'">
          <path :class="partClass('head-back')" @click="toggle('head-back')"
          ...
          <path :class="partClass('nape')" @click="toggle('nape')"
          ...
          <path :class="partClass('back-left')" @click="toggle('back-left')"
          ...
          <path :class="partClass('back-right')" @click="toggle('back-right')"
          ...
          <path :class="partClass('column')" @click="toggle('column')"
          ...
          <path :class="partClass('loin')" @click="toggle('loin')"
          ...
          <path :class="partClass('buttock')" @click="toggle('buttock')"
          ...
          <path :class="partClass('leg-left')" @click="toggle('leg-left')"
          ...
          <path :class="partClass('leg-right')" @click="toggle('leg-right')"
    ...
    <!-- Selected part chips -->
    <div v-if="selected.size > 0" class="flex flex-wrap gap-2 items-center">
      <span
        v-for="part in selected"
        :key="part"
        class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-primary/15 text-primary cursor-pointer hover:bg-primary/25 transition-colors"
        @click="toggle(part)"
      >
    ...
    <p v-else class="text-sm text-muted-foreground">Click a region on the diagram to select it.</p>
  </div>
</template>
...
.body-part:hover {
  fill: color-mix(in oklch, var(--color-primary) 45%, var(--color-muted));
}

.body-part.is-selected {
  fill: color-mix(in oklch, var(--color-primary) 80%, transparent);
