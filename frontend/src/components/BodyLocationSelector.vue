	...
	<div class="body-selector">
		...
		<div class="flex items-center justify-between mb-4">
			<div class="view-toggle">
				<button class="view-tab" :class="{ active: view === 'front' }" @click="view = 'front'">
					Front
					<span v-if="frontCount > 0" class="count-badge">{{ frontCount }}</span>
				</button>
				<button class="view-tab" :class="{ active: view === 'back' }" @click="view = 'back'">
					Back
					<span v-if="backCount > 0" class="count-badge">{{ backCount }}</span>
				</button>
			</div>
			<button v-if="totalCount > 0" class="text-xs text-muted-foreground hover:text-foreground transition-colors"
				@click="clear">
				Clear all
			</button>
		</div>
		...
		<div class="diagram-wrap">
			<svg xmlns="http://www.w3.org/2000/svg"
				:viewBox="view === 'front' ? '0 0 33 92.604164' : '35.5 0 33 92.604164'" class="body-svg"
				@mouseleave="hoveredPart = ''">
				<!-- FRONT VIEW -->
				<template v-if="view === 'front'">
					<path :class="partClass('head')" @click="toggle('head')" @mouseenter="hp('head')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('face')" @click="toggle('face')" @mouseenter="hp('face')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('neck')" @click="toggle('neck')" @mouseenter="hp('neck')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('shoulder-left')" @click="toggle('shoulder-left')"
						@mouseenter="hp('shoulder-left')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('shoulder-right')" @click="toggle('shoulder-right')"
						@mouseenter="hp('shoulder-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('arm-left')" @click="toggle('arm-left')" @mouseenter="hp('arm-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('forearm-left')" @click="toggle('forearm-left')"
						@mouseenter="hp('forearm-left')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('elbow-left')" @click="toggle('elbow-left')" @mouseenter="hp('elbow-left')"
						@mouseleave="hoveredPart = ''"
						d="m 28.325215,27.370125 -0.005,3.09419 0.57959,1.91184 0.54538,-2.41185 z" />
					<path :class="partClass('hands-left')" @click="toggle('hands-left')" @mouseenter="hp('hands-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('arm-right')" @click="toggle('arm-right')" @mouseenter="hp('arm-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('forearm-right')" @click="toggle('forearm-right')"
						@mouseenter="hp('forearm-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('elbow-right')" @click="toggle('elbow-right')"
						@mouseenter="hp('elbow-right')" @mouseleave="hoveredPart = ''"
						d="m 3.2054751,27.370125 0.005,3.09419 -0.57959,1.91184 -0.54539,-2.41185 z" />
					<path :class="partClass('hand-right')" @click="toggle('hand-right')" @mouseenter="hp('hand-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('chest-left')" @click="toggle('chest-left')" @mouseenter="hp('chest-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('chest-right')" @click="toggle('chest-right')"
						@mouseenter="hp('chest-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('ribs-left')" @click="toggle('ribs-left')" @mouseenter="hp('ribs-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('ribs-right')" @click="toggle('ribs-right')" @mouseenter="hp('ribs-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('belly-left')" @click="toggle('belly-left')" @mouseenter="hp('belly-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('belly-right')" @click="toggle('belly-right')"
						@mouseenter="hp('belly-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('belly')" @click="toggle('belly')" @mouseenter="hp('belly')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('genitalia')" @click="toggle('genitalia')" @mouseenter="hp('genitalia')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('thigh-left')" @click="toggle('thigh-left')" @mouseenter="hp('thigh-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('innerthigh-left')" @click="toggle('innerthigh-left')"
						@mouseenter="hp('innerthigh-left')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('thigh-right')" @click="toggle('thigh-right')"
						@mouseenter="hp('thigh-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('innerthigh-right')" @click="toggle('innerthigh-right')"
						@mouseenter="hp('innerthigh-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('knee-left')" @click="toggle('knee-left')" @mouseenter="hp('knee-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('knee-right')" @click="toggle('knee-right')" @mouseenter="hp('knee-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('calf-left')" @click="toggle('calf-left')" @mouseenter="hp('calf-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('calf-right')" @click="toggle('calf-right')" @mouseenter="hp('calf-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('feet-left')" @click="toggle('feet-left')" @mouseenter="hp('feet-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('right-feet')" @click="toggle('right-feet')" @mouseenter="hp('right-feet')"
						@mouseleave="hoveredPart = ''"
				...
				<template v-if="view === 'back'">
					<path :class="partClass('head-back')" @click="toggle('head-back')" @mouseenter="hp('head-back')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('nape')" @click="toggle('nape')" @mouseenter="hp('nape')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('clavicule-left')" @click="toggle('clavicule-left')"
						@mouseenter="hp('clavicule-left')" @mouseleave="hoveredPart = ''"
						d="m 49.625175,14.629325 0.063,-2.62462 -0.71441,1.15181 -4.37994,1.49796 4.97857,8.36746 1.83043,5.08188 -0.21949,-13.55362 z" />
					<path :class="partClass('clavicule-right')" @click="toggle('clavicule-right')"
						@mouseenter="hp('clavicule-right')" @mouseleave="hoveredPart = ''"
						d="m 55.439085,14.728535 -0.063,-2.62463 0.71441,1.15181 4.37994,1.49796 -4.97857,8.36746 -1.83043,5.08189 0.21949,-13.55362 z" />
					<path :class="partClass('back-left')" @click="toggle('back-left')" @mouseenter="hp('back-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('back-right')" @click="toggle('back-right')" @mouseenter="hp('back-right')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('column')" @click="toggle('column')" @mouseenter="hp('column')"
						@mouseleave="hoveredPart = ''"
						d="m 51.733705,14.788555 0.53876,25.33066 0.48967,-0.0297 0.65658,-25.3387 -0.28147,-0.84188 -1.25059,-4.9e-4 z" />
					<path :class="partClass('armback-left')" @click="toggle('armback-left')"
						@mouseenter="hp('armback-left')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('armback-right')" @click="toggle('armback-right')"
						@mouseenter="hp('armback-right')" @mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('loin')" @click="toggle('loin')" @mouseenter="hp('loin')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('buttock')" @click="toggle('buttock')" @mouseenter="hp('buttock')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('leg-left')" @click="toggle('leg-left')" @mouseenter="hp('leg-left')"
						@mouseleave="hoveredPart = ''"
					...
					<path :class="partClass('leg-right')" @click="toggle('leg-right')" @mouseenter="hp('leg-right')"
						@mouseleave="hoveredPart = ''"
		...
		<div v-if="totalCount > 0" class="tags-row">
			<button v-for="part in selected" :key="part" class="tag" @click="toggle(part)">
				{{ PART_LABELS[part] ?? part }}
				<svg class="w-2.5 h-2.5 opacity-60" viewBox="0 0 10 10" fill="none">
					<path d="M7.5 2.5L2.5 7.5M2.5 2.5l5 5" stroke="currentColor" stroke-width="1.5"
